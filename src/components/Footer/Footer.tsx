    ...
    <footer className="footer" id="main-footer">
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <p className="footer-tagline">
              NewsFlow — Your trusted source for breaking news, trending stories, and in-depth analysis from around the world.
            </p>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-list">
              {CATEGORIES.map((cat) => (
                <li key={cat.path}>
                  <Link to={cat.path} className="footer-link">{cat.label}</Link>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="footer-bottom">
          ...
          <p>
            Powered by{' '}
            <a href="https://newsapi.org" target="_blank" rel="noopener noreferrer" className="footer-api-link">
              NewsAPI.org
            </a>
          </p>
        </div>
